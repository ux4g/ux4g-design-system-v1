        ...
        <div class="body_raper">
            <div class="body_raper_content">
                <div class="pl-10 pr-10">
                    ...
                    <h1 class="mb-30"> License</h1>
                    <p>Commonly asked questions about UX4G's open source license.</p>
                    <p style="min-height:500px">UX4G is released under the MIT license and is copyright 2022. Boiled down to smaller chunks, it can be described with the following conditions.</p>

<!-- end flat -->
<!-- pagination -->
<div class="col-12 col-sm-12">
            <ul class="pagination pagination_custom justify-content-between">
                    <a class="page-link border-0" href="/about/brand.php">
                        <span>Previous</span>
                        <strong class="d-block">« Brand</strong>
                    </a>
                    <a class="page-link border-0 float-end" href="/about/translations.php">
                        <span class="text-end">Next</span>
                        <strong class="d-block">Translations »</strong>
                    </a>
