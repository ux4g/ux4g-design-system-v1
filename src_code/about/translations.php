        ...
        <div class="body_raper">
            <div class="body_raper_content">
                <div class="pl-10 pr-10">
                    ...
                    <h1 class="mb-30"> Translations</h1>
                    <p>Links to community-translated UX4G documentation sites.</p>
                    <p style="min-height:500px">Community members have translated UX4G's documentation into various languages. None are officially supported and they may not always be up to date.</p>
